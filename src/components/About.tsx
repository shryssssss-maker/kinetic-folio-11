        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className={`text-6xl md:text-8xl font-display font-light transition-all duration-1000 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-12"}`}>
              <GlowText text="About Me" glowType="accent" />
            </h2>
          </div>
          ...
          <div className="space-y-6">
            ...
            transitionDelay: "200ms"
              ...
              <GlowText text="Hey, I'm Shreyas Singh , a curious mind who loves exploring how things work and finding meaning in what I build. I'm not chasing perfection just learning, creating, and following curiosity wherever it leads." glowType="subtle" />
            </p>
            ...
            transitionDelay: "600ms"
              ...
              <span className="text-sm uppercase tracking-wider text-muted-foreground">
                <GlowText text="Currently learning" glowType="subtle" />
              </span>
              <p className="mt-2 text-lg text-foreground/80">
                <GlowText text="C++ • front end • backend • Python" glowType="subtle" />
              </p>
            </div>
          </div>
        </div>
