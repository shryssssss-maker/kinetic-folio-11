...
const Skills = () => {
  ...
  return <section ref={sectionRef} className="min-h-screen flex items-center justify-center px-6 py-24 overflow-hidden">
      <div className="max-w-6xl w-full">
          ...
          transition: "transform 0.1s linear"
            ...
            return <div key={skill.name} className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-24" style={{
              ...
              transformStyle: "preserve-3d"
                  ...
                  <div className="w-full h-full bg-card border border-border p-6 backdrop-blur-sm flex flex-col justify-center items-center transition-all hover:bg-card/80 hover:border-primary/50 rounded-sm my-0 mx-[100px] px-0 py-0">
        ...
        <p className={`text-center text-muted-foreground mt-12 transition-all duration-1000 ${isVisible ? "opacity-100" : "opacity-0"}`} style={{
